...
write_out() {
    ...
    [Rr])
        ...
        echo "<span style=\"color: red;\"><strong>$2</strong></span>" >> $GITHUB_STEP_SUMMARY
        ;;

    # yellow output
    [Yy])
        echo "${BOLD}${YELLOW}$2${NORMAL}" 1>&1
        echo "<span style=\"color: yellow;\"><strong>$2</strong></span>" >> $GITHUB_STEP_SUMMARY
        ;;

    # green output
    [Gg])
        echo "${BOLD}${GREEN}$2${NORMAL}" 1>&1
        echo "<span style=\"color: green;\"><strong>$2</strong></span>" >> $GITHUB_STEP_SUMMARY
        ;;
    ...
    0)
        ...
        echo "<span style=\"color: green;\"><strong>安全退出</strong></span>" >> $GITHUB_STEP_SUMMARY
        early_exit_cleanup
        exit 0
        ;;
    ...
    *)
        ...
        echo "<span style=\"color: red;\"><strong>错误: 退出 $1</strong></span>" >> $GITHUB_STEP_SUMMARY
        printf '%s\n' "$2" 1>&2
